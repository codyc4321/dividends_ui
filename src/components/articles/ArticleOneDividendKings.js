...
const ArticleOneDividendKings = () => {
  return (
    <div className="ui segment">
      ...
      3M (MMM, they make most of the tape you use), and Target superstore (TGT).</p>
      <p>Although the extra criteria for aristocrats is more specific, some dividend kings are also aristocrats.</p>
      <p>Because 50 years of raised dividends is much longer than 25 years, there is usually less kings than aristocrats. Most recently, there are 65 aristocrats and 45 kings.</p>
      ...
      dividend rate increases to $10 per year 20 year from now, you will be earning 10% on your initial investment, plus
      ...
      Set the dividend search to 20 years, and see how much Home Depot's dividend has increased longterm.</p>
      ...
      <ul>
        ...
        <li>Due to con above, high dividend paying stocks usually produce less capital gains than growth stocks</li>
